// ============================================================
// detail_translate.js — 详情内 Hook 实时翻译行 + 每游戏文本清洗配置
// 依赖：state.js / core.js（toast）/ ui.js / hook_select.js（HookSelect）
// 定义：renderTransRow / loadCleanCfg / collectCleanCfg / saveCleanCfg / resetCleanCfg
// 被依赖：detail.js（refreshDetail 调用 renderTransRow）
// 注意：window.CLEAN_FILTER_DEFS 由 settings.js 提供（FILTER_DEFS 全局暴露）
// ============================================================
