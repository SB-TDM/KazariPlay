// ============================================================
// detail.js — 详情底部抽屉（Modal Bottom Sheet）：展示 + 评分 + 收藏 + 事件
// 依赖：state.js / core.js（loadCoverTo/toast/chipColor/esc）/ ui.js（showSheet/closeSheet/
//       showConfirmDialog）/ games.js（setActiveCard/markRunning）/
//       screenshots.js（renderScreenshots）/ collections.js（openCollectionManager）/
//       detail_translate.js（renderTransRow）
