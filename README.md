...
原名 Minato Launcher，V1.0 起正式更名为 **KazariPlay**。
...
- **详情底部抽屉（Modal Bottom Sheet）**：点击卡片底部上拉，信息栏 3 列、标签 chips、简介
- **批量选择模式**：卡片圆形勾选框 + 批量工具栏（全选/批量加标签/移除标签/移动分组/从库移除）
- **标签与分类**：标签管理抽屉（糖果色 chips、新建/删除）、分类筛选
